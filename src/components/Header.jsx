export function Header ({ score }) {
  return (
    <div className='flex items-center justify-center'>
      <div className='border border-HeaderOutline mx-8 sm:mx-0 w-[340px] sm:w-[700px] m-auto rounded-lg px-8 py-4 flex justify-between'>
        <div className='flex items-center justify-center'>
          <img src='/logo.svg' alt='Titulo del juego' className='w-28 sm:w-32' />
        </div>
